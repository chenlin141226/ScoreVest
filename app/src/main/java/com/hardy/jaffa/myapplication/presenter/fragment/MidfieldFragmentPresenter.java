...
public class MidfieldFragmentPresenter {

    private MidfieldFragment fragment;
    private ResponseInfoAPI responseInfoAPI;

    public MidfieldFragmentPresenter(MidfieldFragment fragment) {
     ...
     */
    public void getData() {
        Call<List<PlayerInfo>> call = responseInfoAPI.getPlayerInfo(Constant.player2);
